...
.Ltmp0:
	...
	shlq	$3, %rcx
	andl	$64, %edx
	leaq	7680(%r9,%rsi), %rsi
	leaq	3644(%r8,%rdi), %rdi
	movb	$1, %r8b
	xorl	%r9d, %r9d
	.loc	1 0 8 is_stmt 0
.Ltmp1:
...
.LBB0_3:
	.loc	1 18 8
	vmovaps	-7680(%r13), %zmm21
	vmovaps	-7168(%r13), %zmm22
	vmovaps	-6656(%r13), %zmm23
	vmovaps	-6144(%r13), %zmm20
	vmovaps	-5632(%r13), %zmm19
	vmovaps	-5120(%r13), %zmm18
	vmovaps	-4608(%r13), %zmm17
	vmovaps	-4096(%r13), %zmm16
	vmovaps	-3584(%r13), %zmm15
	vmovaps	-3072(%r13), %zmm14
	vmovaps	-2560(%r13), %zmm13
	vmovaps	-2048(%r13), %zmm12
	vmovaps	-1536(%r13), %zmm11
	vmovaps	-1024(%r13), %zmm10
	vmovaps	-512(%r13), %zmm9
	vmovaps	(%r13), %zmm8
	addq	$8192, %r13
	vfmadd231ps	-3580(%r9,%r12,4){1to16}, %zmm21, %zmm0
	vfmadd231ps	-3068(%r9,%r12,4){1to16}, %zmm21, %zmm1
	vfmadd231ps	-2556(%r9,%r12,4){1to16}, %zmm21, %zmm2
	vfmadd231ps	-2044(%r9,%r12,4){1to16}, %zmm21, %zmm3
	vfmadd231ps	-1532(%r9,%r12,4){1to16}, %zmm21, %zmm4
	vfmadd231ps	-1020(%r9,%r12,4){1to16}, %zmm21, %zmm5
	vfmadd231ps	-508(%r9,%r12,4){1to16}, %zmm21, %zmm6
	vfmadd231ps	4(%r9,%r12,4){1to16}, %zmm21, %zmm7
	vfmadd231ps	-3576(%r9,%r12,4){1to16}, %zmm22, %zmm0
	vfmadd231ps	-3064(%r9,%r12,4){1to16}, %zmm22, %zmm1
	vfmadd231ps	-2552(%r9,%r12,4){1to16}, %zmm22, %zmm2
	vfmadd231ps	-2040(%r9,%r12,4){1to16}, %zmm22, %zmm3
	vfmadd231ps	-1528(%r9,%r12,4){1to16}, %zmm22, %zmm4
	vfmadd231ps	-1016(%r9,%r12,4){1to16}, %zmm22, %zmm5
	vfmadd231ps	-504(%r9,%r12,4){1to16}, %zmm22, %zmm6
	vfmadd231ps	8(%r9,%r12,4){1to16}, %zmm22, %zmm7
	vfmadd231ps	-3572(%r9,%r12,4){1to16}, %zmm23, %zmm0
	vfmadd231ps	-3060(%r9,%r12,4){1to16}, %zmm23, %zmm1
	vfmadd231ps	-2548(%r9,%r12,4){1to16}, %zmm23, %zmm2
	vfmadd231ps	-2036(%r9,%r12,4){1to16}, %zmm23, %zmm3
	vfmadd231ps	-1524(%r9,%r12,4){1to16}, %zmm23, %zmm4
	vfmadd231ps	-1012(%r9,%r12,4){1to16}, %zmm23, %zmm5
	vfmadd231ps	-500(%r9,%r12,4){1to16}, %zmm23, %zmm6
	vfmadd231ps	12(%r9,%r12,4){1to16}, %zmm23, %zmm7
	vfmadd231ps	-3568(%r9,%r12,4){1to16}, %zmm20, %zmm0
	vfmadd231ps	-3056(%r9,%r12,4){1to16}, %zmm20, %zmm1
	vfmadd231ps	-2544(%r9,%r12,4){1to16}, %zmm20, %zmm2
	vfmadd231ps	-2032(%r9,%r12,4){1to16}, %zmm20, %zmm3
	vfmadd231ps	-1520(%r9,%r12,4){1to16}, %zmm20, %zmm4
	vfmadd231ps	-1008(%r9,%r12,4){1to16}, %zmm20, %zmm5
	vfmadd231ps	-496(%r9,%r12,4){1to16}, %zmm20, %zmm6
	vfmadd231ps	16(%r9,%r12,4){1to16}, %zmm20, %zmm7
	vfmadd231ps	-3564(%r9,%r12,4){1to16}, %zmm19, %zmm0
	vfmadd231ps	-3052(%r9,%r12,4){1to16}, %zmm19, %zmm1
	vfmadd231ps	-2540(%r9,%r12,4){1to16}, %zmm19, %zmm2
	vfmadd231ps	-2028(%r9,%r12,4){1to16}, %zmm19, %zmm3
	vfmadd231ps	-1516(%r9,%r12,4){1to16}, %zmm19, %zmm4
	vfmadd231ps	-1004(%r9,%r12,4){1to16}, %zmm19, %zmm5
	vfmadd231ps	-492(%r9,%r12,4){1to16}, %zmm19, %zmm6
	vfmadd231ps	20(%r9,%r12,4){1to16}, %zmm19, %zmm7
	vfmadd231ps	-3560(%r9,%r12,4){1to16}, %zmm18, %zmm0
	vfmadd231ps	-3048(%r9,%r12,4){1to16}, %zmm18, %zmm1
	vfmadd231ps	-2536(%r9,%r12,4){1to16}, %zmm18, %zmm2
	vfmadd231ps	-2024(%r9,%r12,4){1to16}, %zmm18, %zmm3
	vfmadd231ps	-1512(%r9,%r12,4){1to16}, %zmm18, %zmm4
	vfmadd231ps	-1000(%r9,%r12,4){1to16}, %zmm18, %zmm5
	vfmadd231ps	-488(%r9,%r12,4){1to16}, %zmm18, %zmm6
	vfmadd231ps	24(%r9,%r12,4){1to16}, %zmm18, %zmm7
	vfmadd231ps	-3556(%r9,%r12,4){1to16}, %zmm17, %zmm0
	vfmadd231ps	-3044(%r9,%r12,4){1to16}, %zmm17, %zmm1
	vfmadd231ps	-2532(%r9,%r12,4){1to16}, %zmm17, %zmm2
	vfmadd231ps	-2020(%r9,%r12,4){1to16}, %zmm17, %zmm3
	vfmadd231ps	-1508(%r9,%r12,4){1to16}, %zmm17, %zmm4
	vfmadd231ps	-996(%r9,%r12,4){1to16}, %zmm17, %zmm5
	vfmadd231ps	-484(%r9,%r12,4){1to16}, %zmm17, %zmm6
	vfmadd231ps	28(%r9,%r12,4){1to16}, %zmm17, %zmm7
	vfmadd231ps	-3552(%r9,%r12,4){1to16}, %zmm16, %zmm0
	vfmadd231ps	-3040(%r9,%r12,4){1to16}, %zmm16, %zmm1
	vfmadd231ps	-2528(%r9,%r12,4){1to16}, %zmm16, %zmm2
	vfmadd231ps	-2016(%r9,%r12,4){1to16}, %zmm16, %zmm3
	vfmadd231ps	-1504(%r9,%r12,4){1to16}, %zmm16, %zmm4
	vfmadd231ps	-992(%r9,%r12,4){1to16}, %zmm16, %zmm5
	vfmadd231ps	-480(%r9,%r12,4){1to16}, %zmm16, %zmm6
	vfmadd231ps	32(%r9,%r12,4){1to16}, %zmm16, %zmm7
	vfmadd231ps	-3548(%r9,%r12,4){1to16}, %zmm15, %zmm0
	vfmadd231ps	-3036(%r9,%r12,4){1to16}, %zmm15, %zmm1
	vfmadd231ps	-2524(%r9,%r12,4){1to16}, %zmm15, %zmm2
	vfmadd231ps	-2012(%r9,%r12,4){1to16}, %zmm15, %zmm3
	vfmadd231ps	-1500(%r9,%r12,4){1to16}, %zmm15, %zmm4
	vfmadd231ps	-988(%r9,%r12,4){1to16}, %zmm15, %zmm5
	vfmadd231ps	-476(%r9,%r12,4){1to16}, %zmm15, %zmm6
	vfmadd231ps	36(%r9,%r12,4){1to16}, %zmm15, %zmm7
	vfmadd231ps	-3544(%r9,%r12,4){1to16}, %zmm14, %zmm0
	vfmadd231ps	-3032(%r9,%r12,4){1to16}, %zmm14, %zmm1
	vfmadd231ps	-2520(%r9,%r12,4){1to16}, %zmm14, %zmm2
	vfmadd231ps	-2008(%r9,%r12,4){1to16}, %zmm14, %zmm3
	vfmadd231ps	-1496(%r9,%r12,4){1to16}, %zmm14, %zmm4
	vfmadd231ps	-984(%r9,%r12,4){1to16}, %zmm14, %zmm5
	vfmadd231ps	-472(%r9,%r12,4){1to16}, %zmm14, %zmm6
	vfmadd231ps	40(%r9,%r12,4){1to16}, %zmm14, %zmm7
	vfmadd231ps	-3540(%r9,%r12,4){1to16}, %zmm13, %zmm0
	vfmadd231ps	-3028(%r9,%r12,4){1to16}, %zmm13, %zmm1
	vfmadd231ps	-2516(%r9,%r12,4){1to16}, %zmm13, %zmm2
	vfmadd231ps	-2004(%r9,%r12,4){1to16}, %zmm13, %zmm3
	vfmadd231ps	-1492(%r9,%r12,4){1to16}, %zmm13, %zmm4
	vfmadd231ps	-980(%r9,%r12,4){1to16}, %zmm13, %zmm5
	vfmadd231ps	-468(%r9,%r12,4){1to16}, %zmm13, %zmm6
	vfmadd231ps	44(%r9,%r12,4){1to16}, %zmm13, %zmm7
	vfmadd231ps	-3536(%r9,%r12,4){1to16}, %zmm12, %zmm0
	vfmadd231ps	-3024(%r9,%r12,4){1to16}, %zmm12, %zmm1
	vfmadd231ps	-2512(%r9,%r12,4){1to16}, %zmm12, %zmm2
	vfmadd231ps	-2000(%r9,%r12,4){1to16}, %zmm12, %zmm3
	vfmadd231ps	-1488(%r9,%r12,4){1to16}, %zmm12, %zmm4
	vfmadd231ps	-976(%r9,%r12,4){1to16}, %zmm12, %zmm5
	vfmadd231ps	-464(%r9,%r12,4){1to16}, %zmm12, %zmm6
	vfmadd231ps	48(%r9,%r12,4){1to16}, %zmm12, %zmm7
	vfmadd231ps	-3532(%r9,%r12,4){1to16}, %zmm11, %zmm0
	vfmadd231ps	-3020(%r9,%r12,4){1to16}, %zmm11, %zmm1
	vfmadd231ps	-2508(%r9,%r12,4){1to16}, %zmm11, %zmm2
	vfmadd231ps	-1996(%r9,%r12,4){1to16}, %zmm11, %zmm3
	vfmadd231ps	-1484(%r9,%r12,4){1to16}, %zmm11, %zmm4
	vfmadd231ps	-972(%r9,%r12,4){1to16}, %zmm11, %zmm5
	vfmadd231ps	-460(%r9,%r12,4){1to16}, %zmm11, %zmm6
	vfmadd231ps	52(%r9,%r12,4){1to16}, %zmm11, %zmm7
	vfmadd231ps	-3528(%r9,%r12,4){1to16}, %zmm10, %zmm0
	vfmadd231ps	-3016(%r9,%r12,4){1to16}, %zmm10, %zmm1
	vfmadd231ps	-2504(%r9,%r12,4){1to16}, %zmm10, %zmm2
	vfmadd231ps	-1992(%r9,%r12,4){1to16}, %zmm10, %zmm3
	vfmadd231ps	-1480(%r9,%r12,4){1to16}, %zmm10, %zmm4
	vfmadd231ps	-968(%r9,%r12,4){1to16}, %zmm10, %zmm5
	vfmadd231ps	-456(%r9,%r12,4){1to16}, %zmm10, %zmm6
	vfmadd231ps	56(%r9,%r12,4){1to16}, %zmm10, %zmm7
	vfmadd231ps	-3524(%r9,%r12,4){1to16}, %zmm9, %zmm0
	vfmadd231ps	-3012(%r9,%r12,4){1to16}, %zmm9, %zmm1
	vfmadd231ps	-2500(%r9,%r12,4){1to16}, %zmm9, %zmm2
	vfmadd231ps	-1988(%r9,%r12,4){1to16}, %zmm9, %zmm3
	vfmadd231ps	-1476(%r9,%r12,4){1to16}, %zmm9, %zmm4
	vfmadd231ps	-964(%r9,%r12,4){1to16}, %zmm9, %zmm5
	vfmadd231ps	-452(%r9,%r12,4){1to16}, %zmm9, %zmm6
	vfmadd231ps	60(%r9,%r12,4){1to16}, %zmm9, %zmm7
	vfmadd231ps	-3520(%r9,%r12,4){1to16}, %zmm8, %zmm0
	vfmadd231ps	-3008(%r9,%r12,4){1to16}, %zmm8, %zmm1
	vfmadd231ps	-2496(%r9,%r12,4){1to16}, %zmm8, %zmm2
	vfmadd231ps	-1984(%r9,%r12,4){1to16}, %zmm8, %zmm3
	vfmadd231ps	-1472(%r9,%r12,4){1to16}, %zmm8, %zmm4
	vfmadd231ps	-960(%r9,%r12,4){1to16}, %zmm8, %zmm5
	vfmadd231ps	-448(%r9,%r12,4){1to16}, %zmm8, %zmm6
	vfmadd231ps	64(%r9,%r12,4){1to16}, %zmm8, %zmm7
	addq	$16, %r12
	cmpq	$112, %r12
	jb	.LBB0_3
	vmovaps	%zmm0, (%r10,%r15,4)
	vmovaps	%zmm1, (%r11,%r15,4)
	vmovaps	%zmm2, 512(%r11,%r15,4)
	vmovaps	%zmm3, 1024(%r11,%r15,4)
	vmovaps	%zmm4, 1536(%r11,%r15,4)
	vmovaps	%zmm5, 2048(%r11,%r15,4)
	vmovaps	%zmm6, 2560(%r11,%r15,4)
	vmovaps	%zmm7, 3072(%r11,%r15,4)
	addq	$64, %rbx
	cmpq	$48, %r14
	leaq	16(%r14), %r14
	jb	.LBB0_2
